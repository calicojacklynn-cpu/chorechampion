...
export function EditRewardDialog({ reward, isOpen, onOpenChange, onSave }: EditRewardDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] max-h-[90vh] grid grid-rows-[auto_1fr_auto] p-0">
        ...
        <ScrollArea className="px-6 overflow-y-auto">
          <Form {...form}>
            <form id="edit-reward-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-6">
              <FormField
        ...
        <DialogFooter className="p-6 border-t">
          ...
          <Button type="submit" form="edit-reward-form">Save Changes</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
